...
export const defaultProductsOvershark: Product[] = [
...
export function makeBravosProducts(): Product[] {
  const items: Product[] = [];
  let n = 1;
...
export function makeBoxPrimeProducts(): Product[] {
  const items: Product[] = [];
  let n = 1;
...
export const defaultProductsBravos: Product[] = makeBravosProducts();
export const defaultProductsBoxPrime: Product[] = makeBoxPrimeProducts();
