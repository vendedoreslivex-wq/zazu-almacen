        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="relative">
            <input
              ...
              placeholder="BUSCAR..."
              className="border border-[#141414] bg-white/50 pl-3 pr-8 py-2 text-[10px] font-mono uppercase placeholder:opacity-40 focus:outline-none focus:shadow-[2px_2px_0_#141414] w-40"
            />
