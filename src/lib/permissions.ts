...
export const DEFAULT_ROLE_PERMISSIONS: Record<Role, Record<string, Permission>> = {
  ADMIN_GENERAL: {
    ...
    reservations: 'full', 'odoo-stock': 'full', 'livex-feed': 'full',
  },
  CEO: {
    dashboard: 'full', analysis: 'full', inventory: 'full', locations: 'full',
    operations: 'full', adjustments: 'full', 'purchase-orders': 'full',
    ...
    reservations: 'full', 'odoo-stock': 'full', 'livex-feed': 'view',
  },
  ADMINISTRADOR: {
    dashboard: 'full', analysis: 'full', inventory: 'full', locations: 'full',
    operations: 'full', adjustments: 'full', 'purchase-orders': 'full',
    history: 'view', contacts: 'full', reports: 'full', labels: 'view',
    'warehouse-map': 'view', users: 'view', 'operation-history': 'none',
    reservations: 'full', 'odoo-stock': 'full', 'livex-feed': 'none',
  },
  JEFE_ALMACEN: {
    ...
    reservations: 'full', 'odoo-stock': 'view', 'livex-feed': 'none',
  },
  DESPACHADOR: {
    ...
    reservations: 'full', 'odoo-stock': 'none', 'livex-feed': 'none',
  },
  LIVEX: {
